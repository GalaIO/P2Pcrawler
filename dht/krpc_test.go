...
func TestPingMsg(t *testing.T) {
	...
	assert.Equal(t, Dict{"t": "aa", "y": "e", "e": List{ProtocolErr, "201:cannot find a's val"}}, resp)
}

func TestFindNodeMsg(t *testing.T) {
	msg := withFindNodeMsg("aa", "abcdefghij0123456789", "mnopqrstuvwxyz123456")
	assert.Equal(t, Dict{"t": "aa", "y": "q", "q": "find_node", "a": Dict{"id": "abcdefghij0123456789", "target": "mnopqrstuvwxyz123456"}}, msg)

	resp := findNodeHandle(msg, func(nodeId string) (string, string) {
		return "0123456789abcdefghij", "def456..."
	})
	assert.Equal(t, Dict{"t": "aa", "y": "r", "r": Dict{"id": "0123456789abcdefghij", "nodes": "def456..."}}, resp)
}
