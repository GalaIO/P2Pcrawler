...
func TestHandlePingMsg(t *testing.T) {
	...
	resp := rpcServer.requestHandle(misc.Dict{"t": "aa", "y": "q", "q": "ping", "a": misc.Dict{"id": "abcdefghij0123456789"}})
	assert.Equal(t, misc.Dict{"t": "aa", "y": "r", "r": misc.Dict{"id": "mnopqrstuvwxyz123456"}}, resp.RawData())

	resp = rpcServer.requestHandle(misc.Dict{"t": "aa", "y": "q", "q": "ping"})
...
func TestHandleFindNodeMsg(t *testing.T) {
	...
	resp := rpcServer.requestHandle(misc.Dict{"t": "aa", "y": "q", "q": "find_node", "a": misc.Dict{"id": "abcdefghij0123456789", "target": "mnopqrstuvwxyz123456"}})
